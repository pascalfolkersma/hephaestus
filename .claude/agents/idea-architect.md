...
- `.claude/skills/lore-keeper/SKILL.md` — operations, file naming, index/log semantics.
- `.claude/skills/lore-keeper/references/` — the actual templates (`raw-template.md`, `article-template.md`, `adr-template.md`, `decision-template.md`, `archive-template.md`, `index-template.md`).
